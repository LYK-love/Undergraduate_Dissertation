...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_file_path', required=True, type=str, help='path to original data, this file will make a "id_delete.json" file as output file!')
    # parser.add_argument('--output_file_dir_path', required=True, type=str, help='fir path to output data, filename would be "id_delete.json"')

    args = parser.parse_args()

    # splits = ['train', 'full_valid', 'test']
    splits = ['train', 'test']
